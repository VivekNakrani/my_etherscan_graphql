...
1. Sign up for an Etherscan account at [Etherscan Registration](https://etherscan.io/register)
2. Go to [Etherscan API Key Generation](https://etherscan.io/myapikey) to generate an API key
...
4. Access the Apollo Server by navigating to [http://localhost:9000](http://localhost:9000) on your browser
